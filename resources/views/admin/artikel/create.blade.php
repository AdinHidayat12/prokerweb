        ...
        <div class="col-lg-10">
          ...
          @csrf
            <div class="mb-3">
              ...
              <input value="{{old('judul')}}" type="text" class="form-control @error('judul') is-invalid @enderror" name="judul" placeholder="judul artikel...">
              @error('judul')
            ...
            <div class="mb-3">
              ...
              @enderror
              <input id="x" type="hidden" name="teks" value="{{old('teks')}}">
